...
class CustomerController extends Controller
{
    ...
    //recupera os agenamentos da semana
    public function getWeekAppointments()
    {
        try
        {
            $customer = new CustomerRepository();
            $result = $customer->getWeekAppointments();
    ...
    //recupera os agendamentos dos mes.
    public function getMonthAppointments()
    {
        try
        {
            $customer = new CustomerRepository();
            $result = $customer->getMonthAppointments();
    ...
    //recupera os todos agendamentos.
